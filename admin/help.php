    ...
    <main id="main-content" class="flex-1 ml-64 p-4 lg:p-8 transition-all duration-300">
        ...
        <header class="flex justify-between items-center mb-10 bg-white/50 backdrop-blur-sm p-4 rounded-3xl border border-[var(--border-color)] sticky top-4 z-20 shadow-sm" data-aos="fade-down">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl lg:text-2xl title-font text-[var(--text-dark)] hidden md:block">Pusat Bantuan</h2>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" data-aos="fade-up">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-[2.5rem] p-8 border border-[var(--border-color)] card-shadow">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="faq-item border border-[var(--border-color)] rounded-2xl overflow-hidden bg-[var(--cream-bg)]/30">
                            <button onclick="toggleFaq(this)" class="w-full flex justify-between items-center p-5 text-left focus:outline-none hover:bg-[var(--light-sage)]/20 transition-colors">
                                <span class="font-bold text-[var(--text-dark)] text-sm"><?= $faq['question'] ?></span>
                                <span class="material-symbols-outlined text-[var(--text-muted)] icon-rotate transition-transform duration-300">expand_more</span>
                            </button>
                            <div class="faq-content">
                                <div class="px-5 pb-5 pt-0 text-sm text-[var(--text-muted)] leading-relaxed border-t border-dashed border-[var(--border-color)] bg-white p-4">
                                    <?= $faq['answer'] ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2.5rem] p-6 border border-[var(--border-color)] card-shadow text-center">
                    <span class="material-symbols-outlined text-4xl text-[var(--light-sage)] mb-2">security</span>
                    <h4 class="font-bold text-[var(--deep-forest)] mb-1">Keamanan Data</h4>
                    <p class="text-xs text-[var(--text-muted)]">Pastikan selalu Log Out setelah selesai mengelola sistem.</p>
                </div>
            </div>
