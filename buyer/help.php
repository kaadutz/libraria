...
<body class="bg-background-light dark:bg-background-dark text-stone-800 dark:text-stone-200 transition-colors duration-500 antialiased selection:bg-tan selection:text-white overflow-x-hidden">
    ...
    <main class="flex-1 pt-32 pb-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        ...
        <div class="text-center mb-12" data-aos="fade-down">
            <span class="material-symbols-outlined text-5xl text-tan mb-4">support_agent</span>
            <h1 class="text-3xl lg:text-4xl font-bold text-primary dark:text-sage title-font mb-2">Pusat Bantuan</h1>
            <p class="text-stone-500 dark:text-stone-400">Temukan jawaban atas pertanyaan Anda seputar belanja di Libraria.</p>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">

            <div class="lg:col-span-2 space-y-4" data-aos="fade-right">
                <h3 class="text-xl font-bold text-stone-800 dark:text-stone-200 mb-6">Pertanyaan Umum (FAQ)</h3>
            ...
            <div class="space-y-6" data-aos="fade-left">
                <h3 class="text-xl font-bold text-stone-800 dark:text-stone-200 mb-6">Hubungi Kami</h3>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-tan/20 dark:border-stone-800">
                    <h4 class="font-bold text-primary dark:text-sage mb-4">Lokasi Kantor</h4>
                    <p class="text-sm text-stone-500 dark:text-stone-400 flex items-start gap-2">
                        <span class="material-symbols-outlined text-tan shrink-0">location_on</span>
