        ...
        <header class="flex justify-between items-center mb-8 bg-white/50 backdrop-blur-sm p-4 rounded-3xl border border-tan/20 dark:border-stone-800 sticky top-4 z-20 shadow-sm" data-aos="fade-down">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex items-center gap-2 text-sm font-bold text-stone-400">
                    <a href="products.php" class="hover:text-primary dark:text-sage transition-colors">Produk Saya</a>
                    <span class="material-symbols-outlined text-xs">arrow_forward_ios</span>
                    <span class="text-primary dark:text-sage">Detail</span>
                </div>
            </div>
...
<button onclick="toggleDropdown('notificationDropdown')" class="w-10 h-10 rounded-full bg-white border border-tan/20 dark:border-stone-800 flex items-center justify-center text-stone-500 dark:text-stone-400 hover:text-primary dark:text-sage hover:shadow-md transition-all relative">
        ...
        <div class="bg-white rounded-[2.5rem] p-8 lg:p-10 border border-tan/20 dark:border-stone-800 card-shadow relative overflow-hidden" data-aos="fade-up">

            <div class="flex flex-col lg:flex-row gap-10">

                <div class="lg:w-4/12 flex flex-col gap-4">
                    <div class="aspect-[3/4] rounded-3xl overflow-hidden bg-stone-100 border border-tan/20 dark:border-stone-800 shadow-inner relative group">
                    ...
                    <div class="text-center">
                         <span class="px-4 py-2 bg-sage/30 text-primary dark:text-sage rounded-full text-xs font-bold uppercase tracking-widest border border-[var(--light-sage)]">
                            <?= $book['category_name'] ?>
                        </span>
                    </div>
                </div>
                ...
                <div class="lg:w-8/12 flex flex-col">
                    <div class="mb-6">
                        <h1 class="text-3xl lg:text-4xl font-bold text-stone-800 dark:text-stone-200 leading-tight mb-2 title-font"><?= $book['title'] ?></h1>

                        <div class="flex items-center gap-2 text-stone-500 dark:text-stone-400 text-sm mb-2">
                            <span class="material-symbols-outlined text-lg">person</span>
                            <span class="font-semibold">Penulis:</span>
                            <span class="text-primary dark:text-sage font-bold"><?= $author_name ?></span>
                        </div>

                        <p class="text-sm text-stone-500 dark:text-stone-400 flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div class="p-5 rounded-3xl bg-cream dark:bg-stone-800 border border-tan/20 dark:border-stone-800 relative overflow-hidden">
                            <div class="absolute -right-4 -top-4 w-16 h-16 bg-tan/10 rounded-full blur-xl"></div>
                            <p class="text-[10px] font-bold text-stone-500 uppercase tracking-widest mb-1">Harga Jual</p>
                            <p class="text-2xl font-bold text-chocolate dark:text-tan">Rp <?= number_format($book['sell_price'], 0, ',', '.') ?></p>
                        </div>

                        <div class="p-5 rounded-3xl bg-white border border-tan/20 dark:border-stone-800">
                    ...
                    <div class="mb-8 p-4 rounded-2xl border border-dashed border-tan/20 dark:border-stone-800 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-stone-800 dark:text-stone-200"><?= $book['stock'] ?> Eksemplar</p>
                            </div>
                        </div>
                        <?php if($book['stock'] <= 5): ?>
                    ...
                    <div class="mb-8">
                        <h3 class="text-sm font-bold text-stone-800 dark:text-stone-200 uppercase mb-3 border-b border-tan/20 dark:border-stone-800 pb-2">Deskripsi Buku</h3>
